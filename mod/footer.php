...
<div id="f">
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-4">
                    <p style="text-align: center;">Copyright 2020 <a target="_blank" href="https://github.com/ismaelperez8411/autoapirest">AutoAPIrest</a></p>
                </div>
                <div class="col-sm-4">
                    <p style="text-align: right;">Modified By <a target="_blank" href="https://github.com/ismaelperez8411">Ismael Pérez Díaz</a></p>
                </div>
            </div>
        </div>
    </div>
